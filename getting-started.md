...
For information about using Watson Query with Cloud Pak for Data as a Service, see [Virtualizing data](https://dataplatform.cloud.ibm.com/docs/content/dvaas/virtualizing_data.html).
