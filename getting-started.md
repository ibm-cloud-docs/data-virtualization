...
For information about using Data Virtualzation with Cloud Pak for Data as a Service, see [IBM Docs](https://dataplatform.cloud.ibm.com/docs/content/dvaas/dvaas-overview.html).
